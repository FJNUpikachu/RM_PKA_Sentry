#ifndef RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_MIDDLE_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_MIDDLE_HPP_
 ...
 */
class IsStatusMiddleCondition : public BT::SimpleConditionNode
{
public:
  IsStatusMiddleCondition(const std::string & name, const BT::NodeConfig & config);
  ...
  {
    return {
      BT::InputPort<rm_interfaces::msg::CurrentHP>("message")};
  }
};
}  // namespace rm_behavior_tree

#endif  // RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_MIDDLE_HPP_
