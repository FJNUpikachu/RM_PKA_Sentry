#ifndef RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_BAD_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_BAD_HPP_
 ...
 */
class IsStatusBadCondition : public BT::SimpleConditionNode
{
public:
  IsStatusBadCondition(const std::string & name, const BT::NodeConfig & config);
...
#endif  // RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_BAD_HPP_
