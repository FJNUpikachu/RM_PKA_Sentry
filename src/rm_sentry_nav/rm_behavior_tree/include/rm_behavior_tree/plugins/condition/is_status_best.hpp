#ifndef RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_BEST_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_BEST_HPP_
 ...
 */
class IsStatusBestCondition : public BT::SimpleConditionNode
{
public:
  IsStatusBestCondition(const std::string & name, const BT::NodeConfig & config);
...
#endif  // RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_BEST_HPP_
