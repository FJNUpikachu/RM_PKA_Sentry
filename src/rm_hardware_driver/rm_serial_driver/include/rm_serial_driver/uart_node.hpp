...
private:
  ...
  rclcpp::Publisher<rm_interfaces::msg::SentrySerialReceiveData>::SharedPtr
    sentry_recv_pub_;
  rclcpp::Publisher<rm_interfaces::msg::GameProgress>::SharedPtr game_progress_pub_;
  rclcpp::Publisher<rm_interfaces::msg::CurrentHP>::SharedPtr    current_hp_pub_;
  rclcpp::Publisher<rm_interfaces::msg::BulletRest>::SharedPtr   bullet_rest_pub_;
  rclcpp::Publisher<rm_interfaces::msg::IsBattling>::SharedPtr   is_battling_pub_;
  rclcpp::Publisher<rm_interfaces::msg::IsFortress>::SharedPtr   is_fortress_pub_;
  rclcpp::Publisher<rm_interfaces::msg::IsSupply>::SharedPtr     is_supply_pub_;
  rclcpp::Publisher<rm_interfaces::msg::OutpostHP>::SharedPtr   outpost_hp_pub_;
